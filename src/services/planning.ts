		...
		modules: [
			{
				...
				description: "Set the assumptions, contribution rules, events, and cash-flow inputs that shape every projection in one place.",
			...
			},
			{
				id: "scenarios",
				title: "What If?",
				description: "Organize scenarios and compare future paths before you commit.",
				status: "No scenarios created",
				actionLabel: "Manage What If?",

      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm text-slate-300">
            The current structure shows a net worth of <span className="font-semibold text-white">${summary.netWorth.toLocaleString()}</span> with a debt ratio of <span className="font-semibold text-white">{(summary.debtRatio * 100).toFixed(1)}%</span>.
          </p>
        </div>
